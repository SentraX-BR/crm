...
#### Cannot find module 'sentrax-emails' or its corresponding type declarations.

You have to build the package `sentrax-emails` before running the initialization of the database with `npx nx run sentrax-emails:build`
